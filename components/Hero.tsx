...
export const Hero: React.FC<HeroProps> = ({ sectionRef, onNavigate }) => {
    ...
    return (
        <section id="hero" ref={sectionRef} className="text-center py-20 md:py-32 fade-in-section">
            ...
            <p className="max-w-3xl mx-auto text-xl text-slate-400 mb-8">
                I build robust, end-to-end software solutions driven by data and machine learning. Welcome to my portfolio.
            </p>
